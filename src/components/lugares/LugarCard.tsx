...
export default function LugarCard({
  ...
  if (isSelected) {
    bgClass = "bg-cranberry-50 dark:bg-cranberry-950/20 border-cranberry-300 dark:border-cranberry-800 ring-1 ring-cranberry-300";
  }
  ...
  return (
    ...
    >
      <div className="space-y-2">
        ...
        <div>
          <h4
            className="font-bold text-slate-800 dark:text-slate-100 text-sm leading-tight hover:text-cranberry-700 dark:hover:text-cranberry-400 cursor-pointer"
            onClick={onSelect}
          >
            {lugar.nombre}
          </h4>
      ...
      <div className="flex gap-2 pt-2 border-t border-slate-200/50 dark:border-slate-800">
        {userGpsLocation && (
          <span className="text-[10px] font-bold text-cranberry-600 dark:text-cranberry-400 flex items-center gap-1 bg-cranberry-50 dark:bg-cranberry-950/30 rounded-lg px-2 shrink-0">
        ...
        <button
          onClick={onSelect}
          className="flex-1 text-[11px] font-bold bg-white dark:bg-slate-900 hover:bg-cranberry-700 dark:hover:bg-cranberry-600 hover:text-white dark:hover:text-white text-slate-700 dark:text-slate-300 transition-all rounded-lg py-1.5 px-2 border border-slate-200 dark:border-slate-700 cursor-pointer text-center shadow-sm"
        >
          Mapa
        </button>
        <a
          ...
          className="flex-1 text-[11px] font-bold bg-white dark:bg-slate-900 hover:bg-cranberry-50 dark:hover:bg-cranberry-950/20 text-cranberry-700 dark:text-cranberry-400 transition-all rounded-lg py-1.5 px-2 border border-cranberry-200 dark:border-cranberry-800 cursor-pointer text-center shadow-sm no-underline flex items-center justify-center gap-1"
        >
